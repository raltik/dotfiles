# Generated by Powerlevel10k configuration wizard on 2020-08-22 at 17:23 CEST.
...
# unicode, 24h time, vertical separators, sharp heads, flat tails, 2 lines, solid,
# full frame, light-ornaments, sparse, many icons, concise, instant_prompt=off.
